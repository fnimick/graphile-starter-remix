    ...
    <Row justify="space-between" gutter={32}>
      <Col xs={24} sm={16}>
        ...
        <Paragraph>
          ...
          <a href="https://www.graphile.org/postgraphile/pricing/">going Pro</a>{" "}
        ...
        <Paragraph>
          ...
          the DB; and Apollo is configured to consume them. For example, if you
          register with email/password you may notice the red dot at the top
          right indicating that you need to verify your email. If you verify
          your email in another tab (or even another browser) you should notice
          that this dot disappears. Realtime ✨🌈
        </Paragraph>
