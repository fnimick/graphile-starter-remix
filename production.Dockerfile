...
COPY --from=builder /app/@app/next-client/package.json /app/@app/next-client/package.json
COPY --from=builder /app/@app/next-client/assets/ /app/@app/next-client/assets/
COPY --from=builder /app/@app/next-client/src/next.config.js /app/@app/next-client/src/next.config.js
COPY --from=builder /app/@app/next-client/.next /app/@app/next-client/.next
